...
describe('function getOpeningHours', () => {
...
describe('function isOpenNow', () => {
  ...
  const openingHours8 = '11am – 9:30pm';
  ...
  it('Deals with two open periods in a day', () => {
  ...
  it('Deals with white space', () => {
    expect(isOpenNow(` ${openingHours6}`, nine)).toEqual(true);
  });

  it('Deals with 24 hour opening times', () => {
    expect(isOpenNow(`${openingHours7}`, nine)).toEqual(true);
  });

  it('Deals with lowercase am and pm', () => {
    expect(isOpenNow(`${openingHours8}`, nine)).toEqual(false);
    expect(isOpenNow(`${openingHours8}`, twelve)).toEqual(true);
  });
});
